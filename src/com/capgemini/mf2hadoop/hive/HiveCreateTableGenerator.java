...
public class HiveCreateTableGenerator {
	...
	public StringBuffer generateCreateTableQuery(List<Field> fieldList,
			...
			String fieldsTerminatedBy, String linesTerminatedBy, String storedAs,String tablelocation, boolean partitioned_table, String partition_specification) {
		...
		if(partitioned_table)
			query.append(Mf2HadoopConstants.NEW_LINE).append("PARTITIONED BY (").append(partition_specification).append(" STRING)");
